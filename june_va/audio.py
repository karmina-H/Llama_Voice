...
class AudioIO:
    # pyAudio이용해서 녹음 하고 PyGame을 이용해서 오디오 파일을 재생하는 기능
    """
    ...
    RATE = 24000 # 샘플링 주파수로 1초에 24000개 샘플수집
    CHUNK = 2048 # 마이크에서 데이터 읽을때 한번에 읽는 데이터수
    THRESHOLD = 800 # 무음소리의 최대값
    SILENCE_LIMIT = 3 # 무음상태3초이상 지속되면 녹음종료
    ...
    # 마이크 입력스트림 닫고 pyaudio인스턴스 끝내는 함수
    def close(self) -> None:
        """
